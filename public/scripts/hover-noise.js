document.addEventListener("DOMContentLoaded", () => {
    ...
    const buttons = [...document.querySelectorAll("a.nav-btn"), document.querySelector("#login"), document.querySelector("#okbutton"), document.querySelector("#register"), ...document.querySelectorAll("button")]
